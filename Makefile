#
# OMNeT++/OMNEST Makefile for $(LIB_PREFIX)RedGrande
#
# This file was generated with the command:
#  opp_makemake -f --deep --make-so -O ../out -o RedGrande
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = $(LIB_PREFIX)RedGrande$(D)
...
# Output directory
PROJECT_OUTPUT_DIR = C:/Users/admin/Downloads/omnetpp-6.1.0/omnetpp-6.1/samples/out
PROJECTRELATIVE_PATH = src/simulations
